						...
						<div className = 'c col-lg-6 col-12'>
							<div className = 'left-side mb-lg-0 mb-5 text-lg-start text-center'>
								...
								<div className = 'buttons'>
									...
									<a href="https://mathimatching-27ol87kjo-allendg.vercel.app"  className = 'btn btn-outline-danger text-capitalize shadow'> Game1<i className="ms-2 fas fa-envelope"></i></a>

									<a href="https://quizzdaw-5iagab747-allendg.vercel.app"  className = 'btn btn-outline-danger text-capitalize shadow'> Game2<i className="ms-2 fas fa-envelope"></i></a>
								</div>  
							</div>
						</div>
